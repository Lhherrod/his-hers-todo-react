...
function ListTable({
  ...
  return (
    <>
      ...
      <h1 className="text-center">Her Tasks</h1>
      <div className="container mx-auto w-full tasks-center justify-center">
        <ul className="flex flex-col bg-pink-300 p-4">
          {herTasks.map((task, index) => (
            <li
              className={
                herSelectedTask === index ? "text-green-500" : "text-red-500"
              }
              onClick={() => {
      ...
      <h1 className="text-center">His Tasks</h1>
      <div className="container mx-auto w-full tasks-center justify-center">
        <ul className="flex flex-col bg-blue-300 p-4">
          {hisTasks.map((task, index) => (
            <li
              className={
                HisSelectedTask === index ? "text-green-500" : "text-red-500"
              }
              onClick={() => {
